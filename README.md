...
|---|--------|------------|----------|----------|------|------|
| 1 | Equal Sum Grid Partition I | medium | JavaScript | Prefix Sum | [Link](https://leetcode.com/problems/equal-sum-grid-partition-i/) | 25-03-26 |
| 2 | Equal Sum Grid Partition II | hard | JavaScript | Prefix Sum | [Link](https://leetcode.com/problems/equal-sum-grid-partition-ii/) | 26-03-26 |
| 3 | Matrix Similarity After Cyclic Shifts | easy | JavaScript | Matrix | [Link](https://leetcode.com/problems/matrix-similarity-after-cyclic-shifts/) | 27-03-26 |
| 4 | Find the String with LCP | hard | JavaScript | DP | [Link](https://leetcode.com/problems/find-the-string-with-lcp/) | 28-03-26 |
| 5 | Check if Strings Can be Made Equal... | easy | JavaScript | String | [Link](https://leetcode.com/problems/check-if-strings-can-be-made-equal-with-operations-i/) | 29-03-26 |
...
| 19 | Minimum Distance to Type a Word Us... | hard | JavaScript | DP | [Link](https://leetcode.com/problems/minimum-distance-to-type-a-word-using-two-fingers/) | 12-04-26 |
